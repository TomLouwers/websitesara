...
- grade: 6
- level: "n3"
- topic: "rekenen-met-kommagetallen-in-context"
...
DIDACTIEK (HARD)
- Niveau n3: één kernhandeling per oefening.
...
- taskForm = "context_single_step"
- id patroon: "GB6-RMK-###" (001 t/m 030)
- interaction.type = "numeric"\n- Eén bewerking per opgave, antwoord is numeriek.

Let op:
- solution-format moet schema-proof zijn voor het gekozen interaction-type.
- misconceptKeys: gebruik alleen bestaande keys uit misconcepts/getal-en-bewerkingen.json.
