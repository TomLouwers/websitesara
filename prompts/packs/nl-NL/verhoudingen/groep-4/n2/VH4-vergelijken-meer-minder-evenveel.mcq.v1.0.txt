...
- grade: 4
- level: "n2"
- topic: "vergelijken-meer-minder-evenveel"
...
OPTIE-FORMATS (HARD, EXACT 10 PER FORMAT)
Format A (woorden):
["meer", "minder", "evenveel", "weet ik niet"]
Format B (zinnen):
["Het is meer.", "Het is minder.", "Het is evenveel.", "Dat kun je niet zien."]
Format C (symbolisch):
["meer ↑", "minder ↓", "evenveel =", "onzeker ?"]

MCQ HARD RULE
- Nooit hetzelfde option-format 2× achter elkaar.
- Prompt + option-format combinatie is uniek.
...
- id patroon: "VH4-VMM-###" (001 t/m 030)
- interaction.type = "mcq"\n- taskForm = "select_single"\n- 4 opties, 1 correct (behalve bij breuken-vergelijken: 2 opties ok als je schema dit toestaat).

Let op:
- solution-format moet schema-proof zijn voor het gekozen interaction-type.
- misconceptKeys: gebruik alleen bestaande keys uit misconcepts/verhoudingen.json.
